...
public class Main {
    public static void main(String[] args) {
        ...
        //Bus v = new Bus (15,5,20,60);

        Truck v = new Truck(15, 25, 20, 60);


// get
        System.out.println(v.getPetrol_amount()); // остаток горючего в баке
        System.out.println(v.getTank_volume());   // объем горючего в баке
        System.out.println();
